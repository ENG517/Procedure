...
5. This is a movable square that can be moved or resized to fit your crop needs. 
...
**NOTE:** Update the file name in the Save As name box if needed.
Check the file format you are saving- example JPEG or PNG.
8.Click Save. 
**Note:** Save as original file format. Change the format by using the Save As option and choose the new file format to save the digital image. 
