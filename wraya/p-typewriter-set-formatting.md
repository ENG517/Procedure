...
<!-- See my notes in the loading paper branch to apply here too. -->
...
<!-- Prereqs?? Including loading paper... -->

<!--
  Perhaps provide more context about this first section.
  ## Types of Setting Margins

  When using a manual typewriter, you will need to set two different types of margins: ...

  [enter transition paragraph]
-->
## Setting Margins
...
<!-- Seems more like a new h2 section, rather than a subsection (h3). -->
...
2. Center your Carriage
    <!-- Why do I center it? Also, What's considered "center"? -->
    ...
    <!-- Is this a "Warning" instead of a "Note"? -->
...
3. Move the Margin Stops
    <!-- Why do this? Also, are these unordered steps or ordered? -->
...
<!-- Consider and apply my feedback from above. -->
...
<!-- Is this a separate procedure? How does this pertain to margins? -->
