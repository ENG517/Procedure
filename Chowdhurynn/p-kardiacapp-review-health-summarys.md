...
<!-- This can/is covered in the prereqs. -->
...
<!-- I would simply move this content just after the first sentence. -->
...
<!--
  Consider organizing the prereqs by required and recommended for easier parsing.
-->

<!-- **Before you begin**
 
You must have been using your Kardia app consistently: -->
Consistent use of Kardia app:
 - Installed Kardia and actively used it for at least 2-3 weeks
 ...
 <!-- ## Accessing your Kardia Health Summary -->
<!--
  - I'd remove the bolding, since it isn't used consistently throughout and you are emphasizing the UI elements.
  - Be sure to use periods at the end of your statements for each step. Update throughout.
  -
-->
<!-- suggestion:
  1. **Open** the Kardia app.

  - "on your smartphone" is assumed.
-->
...
5. Verify the date range covers your recent monitoring period
    <!-- Suggestions
      - Should be step 4
      - Alerts should follow a consistent pattern throughout, so perhaps match your use of the "Alert", e.g.:
        **Result:** You should see the Kardia dashboard with ECG trend graphs and recent readings organized by date.
