...
<!-- Comments
  Staging is all about making sure the user knows that this procedure is the correct one for them. In this first paragraph, it reads more like an advertisement with some conceptual info about raster images. In this first paragraph, I'd reivse it to emphasize a main goal statement and separate the definitional work about raster vs. vector images. Perhaps you can create a show section: "What are the Main Differences Between Raster Images versus Vector Images?"
-->
...
<!-- Is this info relevant to this scenario? -->
