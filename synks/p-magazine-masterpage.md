...
- Configure settings for your desired page dimensions and number of pages
...
4. Add a prefix letter in the New Parent dialog box. Your first parent should be "A"
5. Add a name for the master page in the dialog box that appears
4. Click "OK"
>Note: When you have done this successfully, you will see your newly named parent page appear in the pages menu on the right side of the workstation
...
>Note: .25 inches is a good place to start for gutter size, but a smaller size may work better if there are four or more columns
...
1. Go back to the _Pages_ panel and select the parent page at the top of the panel, indicated by a letter in the top corner of the page
