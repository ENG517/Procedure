...
* Must have Stardew Valley Version 1.6 installed
* Must be signed in to Steam
...
* A plot of land on your farm where a number of squares equal to the total number of crops you wish to plant that has been cleared of all grass, saplings, trees, and rocks
...
3. Release your mouse when you are satisfied with your selction of square. This will result in the ground turning darker than before to indicate that it has been tilled.
...
2. Right click on the tilled squares to plant the seed. The scattered seeds should appear on the dirt.
3. Equip the watering can. Right-click on all the freshly planted seeds to water them. 
4. Repeat until you have planted and watered all the seeds.
