...
<!-- Consider and apply feedback from the troubleshooting procedure file/branch throughout this file too. -->
...
<!-- Note the first sentence isn't probably necessary. Unless you help connect the dots between those claims about features and why it's important to understand the terms below. -->
...
<!-- Delete this heading, then start at level h2 for your procedures. -->
## The Instructions

<!-- If these sections are sequenced, then use numbers to denote the process. -->
...
3. Plug one end of your LAN cable into the router's WAN1 port, and plug the other end into the ISP modem.
    ...
    <!-- Revisions:
      - Note the change in indentation to help note the relatedness to the step. You can also reuse this design pattern for your other figures at the step level.
      - I would create a copy of this image, then place a simple box around the correct port.
    -->
...
4. Plug one end of your power adapter to the power port of your router, and connect the other end to your chosen power outlet.
    <!-- Again, copy that image and circle the power port. Another solution is to create a figure with labeled parts at the beginning, which you can then reference throughout. It's slightly better practice to include the information within the step, however. -->
...
<!-- We didn't cover this, but telling people to agree may not be approved by your legal team :-) A caveat will suffice. -->
...
<!-- What if it doesn't work? What could go wrong? -->
