...
2. Add high-efficiency detergent to the washer.
    ...
    * If using liquid detergent, pour detergent into the detergent compartment in the drawer. ![Stackable front, detergent drawer is highlighted](assets/images/combo-front-drawer.png)
  
3. Optional: add bleach and fabric softener into the labeled compartments.
   ![Dispenser drawer with labels](assets/images/dispenser-drawer.jpg)
...
5. Press start or the left control panel.
   ![Stackable unit with washing machine control panel highlighted](assets/images/combo-front-wash-start.png)
