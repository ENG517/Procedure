# How to write a ChatGPT Prompt for grammar checking and text improvement

When using ChatGPT to check grammar or improve your writing, it's important to give clear instructions. Follow these steps to create a well-structured prompt that ensures effective editing.

## Step 1: Provide the text you want to edit

Copy and paste the text that you want ChatGPT to check or improve. 

Example:
> "Here is the text I'd like you to check: 'I was going to the park yesterday, and I have see a dog that is looks very friendly.'"

## Step 2: Specify the type of editing

Define what you want ChatGPT to do. This could include:
- **Grammar check**
- **Spelling check**
...
Example:
> "Please check the grammar and improve the sentence structure for clarity."

## Step 3: Mention any style preferences

If you have a specific writing style or tone in mind, mention it. For example, you may want a formal, professional tone when writing an email to the professor or boss. 

Example:
> "I’d like the text to have a formal tone, suitable for a business email."
